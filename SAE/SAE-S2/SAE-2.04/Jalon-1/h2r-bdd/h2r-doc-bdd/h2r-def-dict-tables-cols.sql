...
COMMENT ON COLUMN CUSTOMER_ADDRESS.ID_CUSTOMER_ADDRESS IS 'Identifier of the customer address';
...
-- Table HOTEL_ADDRESS
COMMENT ON COLUMN HOTEL_ADDRESS.ID_HOTEL_ADDRESS IS 'Identifier of the hotel address';
...
COMMENT ON COLUMN HOTEL.ADDRESS IS 'Address of the hotel';
