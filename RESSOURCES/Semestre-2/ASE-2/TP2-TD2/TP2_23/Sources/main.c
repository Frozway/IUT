/*----------------------------------------------------------------------------
2)	Chenillard à double sens :
Ecrire un programme qui permettra de faire défiler les LEDS du chenillard vers la droite lors d’une action (impulsion) sur le bouton JOY_DROITE
et vers la gauche après une action sur JOY_GAUCHE. La vitesse de défilement devra être de 2 LEDs/seconde.
