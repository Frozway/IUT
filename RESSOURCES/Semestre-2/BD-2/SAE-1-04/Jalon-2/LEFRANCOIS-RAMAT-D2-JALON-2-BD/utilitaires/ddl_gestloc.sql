...
(
  ...
  IBAN_AGENCE  VARCHAR2(27)  NOT NULL,
  SOLDE_AGENCE NUMBER(10) ,
...
(
  ...
  CLASS_DPE    VARCHAR2(1)   NOT NULL,
  STATUT_RENOV VARCHAR2(20) ,
  NB_VISITE NUMBER(5)       ,
...
-- COMMENT ON COLUMN BIEN.CLASS_DPE IS 'Étiquette énergétique';

-- COMMENT ON COLUMN BIEN.STATUT_RENOV IS 'Rénove ?';
