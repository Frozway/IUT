-- ============================================================================
-- Fichier          : test_vue_stats_reparateur.sql
-- Auteur           : Thibaut LEFRANCOIS
-- Date             : 10/03/2023
-- Role             : Tester la vue vue_stats_reparateur
-- Fichier resultat :  test_vue_stats_reparateur.out
-- ============================================================================
...
SPOOL test_vue_stats_reparateur.out
...
prompt 'Conteu de la vue : vue_stats_reparateur'

select *
from   vue_stats_reparateur	;
