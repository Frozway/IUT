...
SET echo ON
@ D:\IUT\RESSOURCES\BD-1\TP\TP6\tests\produitsCommandes\produitsCommandesDistinct.sql
SET echo OFF

prompt 'Resultat de la requete sans Distinct'
SET echo ON
@ D:\IUT\RESSOURCES\BD-1\TP\TP6\tests\produitsCommandes\produitsCommandesSansDistinct.sql
SET echo OFF
