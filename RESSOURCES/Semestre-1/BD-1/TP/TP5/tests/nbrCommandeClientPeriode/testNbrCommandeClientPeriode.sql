-- ============================================================================
-- Fichier          : testNbrCommandeClientPeriode.sql
...
-- Projet			: surgeles
-- Fichier resultat : testNbrCommandeClientPeriode.out
-- ============================================================================
...
-- CAS2: Un client qui a passé 1 commande dans la période et une commande hors de la période
...
------- Le client de la commande
INSERT INTO CLIENT (IDCLI, NOMCLI, PRENOMCLI, TELCLI, MAILCLI, ADRCLI)
VALUES(3, 'DUPONT', 'Martin', '0707070707', 'dupontmartin@example.org', 'Paris');
------- La commande passée par le client
INSERT INTO COMMANDE (IDCOM, IDCLI, DATECOM, DATERECEPPREVI)
VALUES(5, 3, TO_DATE('02/02/2013', 'DD/MM/YYYY'), TO_DATE('20/06/2013', 'DD/MM/YYYY'));
...
PROMPT fichier resultat du test : testNbrCommandeClientPeriode.out
...
SET echo ON
@ D:/IUT/RESSOURCES/BD-1/TP/TP5/tests/nbrCommandeClientPeriode/nbrCommandeClientPeriode.sql ;
SET echo OFF
