...
VALUES (1, 'saumon', 'poisson');
------- Un autre produit
INSERT INTO PRODUIT (IDPRO, NOMPRO, TYPEPRO)
VALUES (2, 'chocolat', 'dessert');
...
INSERT INTO LIGNE_COMMANDE (IDLIGCOM, QTECOM, PRIXUNIT, IDPRO, IDCOM)
VALUES (2, 9, 54.543, 1, 1);
------- 3eme ligne de commande 
INSERT INTO LIGNE_COMMANDE (IDLIGCOM, QTECOM, PRIXUNIT, IDPRO, IDCOM)
VALUES (3, 9, 54.543, 1, 1);
...
SET echo ON
@ C:\Users\tibol\Desktop\IUT\RESSOURCES\BD-1\TP\TP7\tests\maxProCom\maxProCom.sql
SET echo OFF
